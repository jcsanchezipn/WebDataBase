...
namespace WebDataBase.Controllers
{
    public class PersonalsController : Controller
    {
        ...
        public PersonalsController(WebDataBaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,nombres,apellidos,domicilio,fechaNacimiento")] Personal personal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nombres,apellidos,domicilio,fechaNacimiento")] Personal personal)
        {
            if (id != personal.id)
            {
                return NotFound();
